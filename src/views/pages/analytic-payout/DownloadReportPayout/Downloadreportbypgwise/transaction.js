...
const Home = () => {
    ...
    const getallgeneratedreportHandler = () => {
        setBlock(true)
        requestsApidata.reportgetAllReportTrListreportName("TRANSACTION_REPORT_PAYOUT_PG_WISE").then(res => {
    ...
    const countryOptions =
    allpgdetails.map((v) => {
            return { value: v.pgId, label: v.pgName }
        })
    ...
    const downloadreportHandler = () => {
        ...
        if (startDate === "" || endDate === "" || selectpgnameidvalue === "Select") {
            ...
            setbtndisabled(true)
            requestsApidata.payoutgeneratertransactionReport("TRANSACTION_REPORT_PAYOUT_PG_WISE", searchStartDate, searchEndDate, selectpgnameidvalue.value).then((res) => {
