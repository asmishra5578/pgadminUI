...
const Home = () => {
    ...
    const getallgeneratedreportHandler = () => {
        setBlock(true)
        requestsApidata.reportgetAllReportTrListreportName("TRANSACTION_REPORT_PAYOUT_MERCHANT_WISE").then(res => {
    ...
    const downloadreportHandler = () => {
        ...
        if (startDate === "" || endDate === "" || selectmerchantidvalue === "Select") {
            ...
            setbtndisabled(true)
            requestsApidata.payoutgeneratertransactionReport("TRANSACTION_REPORT_PAYOUT_MERCHANT_WISE", searchStartDate, searchEndDate, selectmerchantidvalue.value).then((res) => {
