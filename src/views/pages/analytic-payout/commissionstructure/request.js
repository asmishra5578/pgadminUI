...
export default class requests {
    ...
    // new api
    getmerchantcommission(mid) {
        return axios({
            method: "GET",
            url: `${config.getmerchantcommission}?adminUuid=${uuid}&merchantId=${mid}`
        })
    }
    updatemerchantcommission(merchantId, commissionInPercent) {
        const data = {
            adminUuid:uuid,
            merchantId,
            commissionInPercent
        ...
        return axios({
            method: "PUT",
            url: `${config.updatemerchantcommission}`,
            data
        })
    }
    addmerchantcommission(merchantId, commissionInPercent) {
        const data = {
            adminUuid:uuid,
            merchantId,
            commissionInPercent
        ...
        return axios({
            method: "POST",
            url: `${config.addmerchantcommission}`,
            data
        })
    }
}