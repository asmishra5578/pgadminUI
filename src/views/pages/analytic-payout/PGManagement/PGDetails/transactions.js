...
const DataTableWithButtons = () => {
  ...
  const columns = [
    ...
    {
      name: 'PG Config Key',
      selector: 'pgConfigKey',
      sortable: true,
      minWidth: '350px'
    },
    {
      name: 'PG Config Secret',
      selector: 'pgConfigSecret',
      sortable: true,
      minWidth: '350px'
    },
    {
    ...
    if (e.target.value.length) {
      const updatedData = data.filter(item => {
        const startsWith =
          ...
          item.pgConfigKey.startsWith(e.target.value) ||
          item.pgConfigSecret.startsWith(e.target.value)
        ...
        const includes =
          ...
          item.pgConfigKey.includes(e.target.value) ||
          item.pgConfigSecret.includes(e.target.value)
