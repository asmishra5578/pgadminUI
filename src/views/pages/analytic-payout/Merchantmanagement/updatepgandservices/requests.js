...
export default class requests {
  // merchantlist payout
  findAllPayoutMerchant() {
    return axios({
      method: "GET",
      url: `${config.findAllPayoutMerchant}?uuid=${uuid}`
    })
  }
  payoutgetpglist() {
    return axios({
  ...
  payoutgetAllConfigPgMerchant() {
    return axios({
      method: "GET", 
      url: `${config.payoutgetAllConfigPgMerchant}?uuid=${uuid}`
    })
  }

  payoutconfigPgMerchant(id, services, pgguuid, statuss) {
    const data = {
      merchantId: id,
      service: services,
      pgId: pgguuid,
    ...
    return axios({
      method: "POST", 
      url: `${config.payoutconfigPgMerchant}?uuid=${uuid}`,
      data
    })
  }
  payoutupdateConfigPgMerchant(id, services, pgguuid, statuss) {
    const data = {
      merchantId: id,
      service: services,
      pgId: pgguuid,
    ...
    return axios({
      method: "PUT", 
      url: `${config.payoutupdateConfigPgMerchant}?uuid=${uuid}`,
      data
    })
  }
  // comment below

  updateStatusPayoutMerchant(merchantid, statuss) {
    const data = {
    ...
    return axios({
      method: "PUT",
      url: `${config.updateStatusPayoutMerchant}?uuid=${uuid}&status=${statuss}&merchantId=${merchantid}`,
      data
    })
  }
