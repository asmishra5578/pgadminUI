...
const Settlementreport = () => {
  ...
  const getalldataHandler = () => {
    setBlock(true)
    requestsApidata.getalltxnupdatefiles('REVERSAL').then(res => {
  ...
  const finaluploadHandler = () => {
    ...
    setdisableduplodbtnfinal(true)
      requestsApidata.bulktransactionReversal(bodyFormData).then((res) => {
        setdisableduplodbtnfinal(false)
    ...
    <Fragment>
      <UILoader blocking={block}>
        ...
        <DataTableWithButtons data={data} coloumnsprops={columns}
          ...
          routename="Payout Bulk Transaction Reversal" />
      </UILoader>
      <Modal
        isOpen={modal}
        ...
        <div style={{ marginLeft: 30, marginTop: -30 }}>
          ...
          <p>Download Sample File<span>
            <Badge style={{ marginLeft: 20, cursor: 'pointer' }} color="primary">
              <a href='https://vpay-app-files.s3.ap-south-1.amazonaws.com/sampleFileDownload/BalanceReversal.xlsx' download>Click to download XLSX</a>
            </Badge>
            <Badge style={{ marginLeft: 20, cursor: 'pointer' }} color='primary'>
              <a href='https://vpay-app-files.s3.ap-south-1.amazonaws.com/sampleFileDownload/BalanceReversal.csv' download>Click to download CSV</a>
            </Badge></span>
          </p>
        </div>
        <ModalBody className='flex-grow-1'>
          <CardTitle tag='h4'>Reversal Upload File</CardTitle>
