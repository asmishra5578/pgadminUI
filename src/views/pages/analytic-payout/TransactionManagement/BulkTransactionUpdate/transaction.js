...
const Settlementreport = () => {
  ...
  const getalldataHandler = () => {
    setBlock(true)
    requestsApidata.getalltxnupdatefiles('PAYOUT').then(res => {
  ...
  const finaluploadHandler = () => {
    ...
    setdisableduplodbtnfinal(true)
      requestsApidata.PAYOUTupdatetxnStatusfileupload(bodyFormData).then((res) => {
        setdisableduplodbtnfinal(false)
    ...
    <Fragment>
      <UILoader blocking={block}>
        ...
        <DataTableWithButtons data={data} coloumnsprops={columns}
          ...
          routename="Payout Bulk Transaction Update" />
      </UILoader>
      <Modal
        isOpen={modal}
