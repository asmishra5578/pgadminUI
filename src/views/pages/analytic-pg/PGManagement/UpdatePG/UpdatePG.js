...
const DataTableWithButtons = (props) => {
    ...
    const updatepglimithandler = (e) => {
        ...
        Swal.fire({
            title: "Input PG Limit in Rupees",
    ...
    const updateconfigurationHandler = (e) => {
        console.log('e', e.target.id)
        setPGuuidselect(e.target.id)
        updatepghandleModal()
    }
    const updatepgdetailsHandler = (data) => {
        console.log('updatepgdetailshansderlslsslHandler', data)
        // console.log('submitpgdetaislcreation', data)
        setupdatepgbtndisabled(true)
        if (data.pgAddInfo1 === "" && data.pgAddInfo2 === "" && data.pgAddInfo3 === "" && data.pgAppId === "" && data.pgDailyLimit === "" && data.pgName === undefined && data.pgSaltKey === "" && data.pgSecretKey === "" && data.pgUuid === undefined) {
            toast.warning('All details can not be empty')
        ...
        <Fragment>
            <Card>
                <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
                    <CardTitle tag='h4'>Update PG Configuration</CardTitle>
                </CardHeader>
                <CardBody>
                            ...
                            <Row>
                                {alreadyserviceData.map((v) => {
                                    return <div style={{ marginLeft: 20 }}>
                                        ...
                                        <p>Update Configuration:<Badge style={{ marginLeft: 20, cursor: 'pointer' }} id={v.pg_uuid} color='success' onClick={updateconfigurationHandler}>Update</Badge> </p>
                                        ...
                                        <p>PG Limit:₹{v.pg_daily_limit === null ? "0" : v.pg_daily_limit}<span>
                        ...
                        <Row>
                            ...
                            <Row>
                                <div style={{ marginLeft: 20 }}>
                                    <Button color='primary' onClick={refreshdataHandler}>Reset
            ...
            <PGUpdateModal open={updatepgmodal} PGuuidselect={PGuuidselect}
             handleModal={updatepghandleModal} disabledbtns={updatepgbtndisabled} parentCallback={updatepgdetailsHandler} />
