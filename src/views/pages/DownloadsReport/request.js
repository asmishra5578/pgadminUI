...
export default class requests  {
    dateWiseTxnWithParameters(startdate, enddate, merchantid, pgtype, paymentoption, merchantorderid, trid, pgid) {
        return axios({
            method: "GET",
            url: `${config.dateWiseTxnWithParameters}?uuid=${uuid}&start_date=${startdate}&end_date=${enddate}&merchant_id=${merchantid}&pgType=${pgtype}&payment_option=${paymentoption}&merchant_order_id=${merchantorderid}&trId=${trid}&pg_id=${pgid}`
