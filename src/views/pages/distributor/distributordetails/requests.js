...
updatedistributorstatusbyadmin(distributorid, status) {
  return axios({
    method: "PUT",
    url: `${config.updatedistributorstatusbyadmin}?uuid=${uuid}&distributorID=${distributorid}&status=${status}`
  })
}
createDistributorbyAdmin(data) {
  return axios({
    method: "POST",
    url: `${config.createDistributorbyAdmin}?uuid=${uuid}`,
    data
  })
}
updateDistributorDetailsbyAdmin(distributorid, data) {
  return axios({
    method: "PUT",
    url: `${config.updateDistributorDetailsbyAdmin}?uuid=${uuid}&distributorID=${distributorid}`,
    data
  })
}
}
